# DSP391m â€“ Group 5
## Report 3 â€“ Task 3 | Data Collection, Cleaning & Analysis
...
The Open University Learning Analytics Dataset (OULAD) is a publicly available evansonational dataset released by the Knowledge Media Institute (KMi) at The Open University (OU), United Kingdom. It was formally published in 2017 by Kuzilek, Hlosta, and Zdrahal as a data descriptor in *Scientific Data* (Nature Publishing Group).

OULAD is one of the most widely cited open datasets in the Learning Analytics and Evansonational Data Mining (EDM) research communities. As of 2025, the original data descriptor paper has accumulated several hundred citations across IEEE, ACM, Springer, and Elsevier publications.
...
The OU operates as a fully distance-learning institution, meaning all studentâ€“course interaction occurs digitally through the VLE. This makes it uniquely suited for learning analytics research: every student action â€” reading materials, submitting assessments, browsing resources â€” is captured as a timestamped log entry.
...
**Key statistics:** 32,593 enrolments (28,785 distinct students) â€¢ 22 moduleâ€“semester combinations â€¢ 7 CSV tables â€¢ 10,655,280 VLE interaction entries
...
| **Reprovansone in publications** | Include data excerpts, tables, and derived outputs in academic reports and papers. |
...
3. Stating the license type (CC-BY 4.0) in this ethics section and in the reprovansonibility documentation (Step 31).
...
- Age is reported as a banded category (0â€“35, 35â€“55, 55+), not as exact birth dates.
...
Because OULAD is secondary data â€” collected and anonymised by a third party (The Open University) under its own institutional ethical framework â€” this project is not required to obtain individual consent from the students represented in the dataset. The original data collection was convansonted under the OU's internal ethics procedures, and the public release under CC-BY 4.0 constitutes the OU's authorisation for downstream research use.
